export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'commit_proposal_many_assets_upload' : IDL.Func(
        [IDL.Vec(CommitBatch)],
        [],
        [],
      ),
    ...
    'init_proposal_asset_upload' : IDL.Func(
        [InitAssetKey, IDL.Nat],
        [InitUploadResult],
        [],
      ),
    ...
    'upload_proposal_asset_chunk' : IDL.Func(
        [UploadChunk],
        [UploadChunkResult],
        [],
      ),
