...
export interface ConfigTypes {  auth: {    iid: {      enabled: boolean;
      domain: string;
    };
  ...
  blockchain: {    avalanche: {      anvil: {        url: string;
    ...
    icp: {      evm_rpc: {        anvil: {          canister_id: string;
          rpc_url: string;
        };
        testnet: {          canister_id: string;
          rpc_urls: string[];
        };
        mainnet: {          canister_id: string;
          rpc_urls: string[];
        };
      };
    };
  ...
  gameplay: {    time_limit_seconds: number;
    ...
    vault: {      payout_max_score: number;
      ...
      difficulty_multipliers: {        building: number;
        sweet_spot: number;
        fomo: number;
        legendary: number;
      };
      payout_fixed: {        building: number;
      };
      payout_percentages: {        sweet_spot: number;
        fomo: number;
        legendary: number;
      };
    };
      ...
      enemy: {        health: number;
        ...
        ai: {          weights: {            cautious: number;
          ...
          flanker: {            speed_mult: number;
            ...
            switch_time: number;
            orbit_time: number;
            orbit_time_variance: number;
            lunge_speed_mult: number;
            lunge_duration: number;
            lunge_tint: number;
            recovery_time: number;
            recovery_lateral_bias: number;
          };
          passive: {            speed_mult: number;
            provoked_speed_mult: number;
            hp_mult: number;
            provoked_tint: number;
            provoke_delay: number;
            forgiveness_time: number;
            wander_frequency: number;
            wander_amplitude: number;
          };
    ...
    audio: {      default_music_volume: number;
      ...
      sfx_volume_overrides: {        bot_attack: number;
        bot_spawn: number;
        bot_special: number;
        countdown: number;
        death: number;
  ...
  anti_cheat: {    ban_durations_hours: Array<number>;
    ...
    replay: {      max_actions: number;
      ...
      grace_ms: number;
      burst_limit_per_100ms: number;
      min_actions: number;
      attack_per_key_divisor: number;
    };
  };
